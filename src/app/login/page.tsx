  ...
  return (
    <div className="flex flex-col items-center justify-center h-screen bg-[url(/clouds.webp)] bg-cover">
      <div className="bg-gradient-to-t from-white to-[#9ac8e7] p-7 mx-5 rounded-2xl flex flex-col ">
        ...
        <h2 className="max-w-md text-center mx-auto text text-[var(--lightGrey)]">Realize your investing and personal finance potential. For free</h2>
        <div className="mt-4">
          <input
            type="text"
        ...
        <div className="flex align-items justify-around my-4">
          <button onClick={handleGoogleLogin} className="flex items-center justify-center bg-[var(--white)] p-3 rounded-xl gap-2">
            <Image src="/google.png" alt="Logo" width={40} height={540} className=" mx-auto" />
            <h3>Google</h3>
          </button>
          <button onClick={handleGithubLogin} className="flex items-center justify-center bg-[var(--white)] p-3 rounded-xl gap-2">
